# <span style="color:green">Three-Tier Architecture — Terraform on AWS 📦</span>
...
![AWS Three Tier Architecture – Terraform VPC, Public, Private, Database Subnets](./assets/three-tier-architecture.png)
